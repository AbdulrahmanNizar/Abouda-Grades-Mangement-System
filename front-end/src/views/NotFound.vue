<template>
  <div class="h-100 text-black" v-if="userAuthorized">
    ...
    <div class="vh-100 w-100 d-flex flex-row justify-content-start align-items-center m-0">
      ...
      >
        ...
        <div class="w-100 d-flex flex-column justify-content-center align-items-center mb-3">
          ...
          <div class="w-100 d-flex flex-column justify-content-center align-items-center" v-else>
            <img
              src="../images/DefaultUserPicture.jpg"
              alt="profile-photo text-white"
              class="img-fluid"
              style="width: 41%; height: 97%; border-radius: 50%; mix-blend-mode: multiply"
            />
            <h6 class="text-center text-white mt-2">{{ userInfo[0].username }}</h6>
            <hr class="w-100 text-white" />
          </div>
      ...
      <div
        class="h-100 overflow-y-auto text-black d-flex flex-column justify-content-center align-items-center"
        style="width: 84%"
        id="dashboard"
      >
        <div class="h-100 d-flex flex-row justify-content-center align-items-center">
          <div
            class="shadow rounded p-5 d-flex flex-column justify-content-center align-items-center"
            v-motion-slide-bottom
          >
            <h2>Page Not Found</h2>
            <hr class="w-100" />
            <router-link :to="{ path: '/' }" class="btn btn-dark w-100">Home</router-link>
          </div>
        </div>
      </div>
    </div>
